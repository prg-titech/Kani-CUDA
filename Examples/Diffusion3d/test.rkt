...
(define (diffusion-kernel in
  ...
  (= [out c] (+/LS (*/LS cc tc)
                   ;                   (*/LS cw (?: (&&/LS (eq?/LS tid-x (? 0 (-/LS (block-dim 0) 1))) (neq?/LS i 0))
                   ;                                [in ((? +/LS -/LS) c 1)]
                   ;                                [smem (?: (eq?/LS i 0) c2 ((? +/LS -/LS) c2 (? 1 (block-dim 0) SIZE)))]))
                   ;                   (*/LS ce (?: (&&/LS (eq?/LS tid-x (? 0 (-/LS (block-dim 0) 1))) (neq?/LS i (-/LS nx 1)))
                   ;                                [in ((? +/LS -/LS) c 1)]
                   ;                                [smem (?: (eq?/LS i (-/LS nx 1)) c2 ((? +/LS -/LS) c2 (? 1 (block-dim 0) SIZE)))]))
                   ;                   (*/LS cn (?: (&&/LS (eq?/LS tid-y (? 0 (-/LS (block-dim 1) 1))) (neq?/LS j 0))
                   ;                                [in ((? +/LS -/LS) c nx)]
                   ;                                [smem (?: (eq?/LS j 0) c2 ((? +/LS -/LS) c2 (? 1 (block-dim 0) SIZE)))]))
                   ;                   (*/LS cs (?: (&&/LS (eq?/LS tid-y (? 0 (-/LS (block-dim 1) 1))) (neq?/LS j (-/LS ny 1)))
                   ;                                [in ((? +/LS -/LS) c nx)]
                   ;                                [smem (?: (eq?/LS j (-/LS ny 1)) c2 ((? +/LS -/LS) c2 (? 1 (block-dim 0) SIZE)))]))
                   (w c)
                   (e c)
                   (n c)
                   (s c)
