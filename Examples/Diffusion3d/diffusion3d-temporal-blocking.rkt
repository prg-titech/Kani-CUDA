...
;  (printf "sc = ~a\n" sc)
  ...
  (= i2 (+/LS (*/LS (-/LS (block-dim 0) 2) (block-idx 0)) (min (thread-idx 0) (-/LS (block-dim 0) 3))))
  (= i2 (min i2 (-/LS nx 1)))
  (= j2 (+/LS (*/LS (-/LS (block-dim 1) 2) (block-idx 1)) (min (thread-idx 1) (-/LS (block-dim 1) 3))))
  (= j2 (min j2 (-/LS ny 1)))
;  (printf "i2 = ~a\n" i2)
;  (printf "j2 = ~a\n" j2)
  (= c2 (+/LS i2 (*/LS j2 nx)))
