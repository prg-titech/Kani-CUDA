            ...
            (+/LS
             (+/LS
              (*/LS
               ...
               (?: (&&/LS ((? eq?/LS neq?/LS) (? (thread-idx 0) (thread-idx 1)) (-/LS (block-dim 0) 1)) ((? eq?/LS neq?/LS) (thread-idx 1) 0))
                   (sb (-/LS (-/LS csb 1) (block-dim 0)))
                   (p
                    (+/LS
...
(define (main)
  ...
  final_gosa
  (synthesize #:forall '()
              #:guarantee (array-eq-verify gosa-spec gosa THREADNUM)))
