...
(define (arith-exp- bidx j bdimx i g-loc BLOCKSIZE gdimy bidy tidy value b-loc tidx sum bdimy gdimx KERNEL-RADIUS) (arith-exp bidx j bdimx i g-loc BLOCKSIZE gdimy bidy tidy value b-loc tidx sum bdimy gdimx KERNEL-RADIUS 3))
